...
main_scores_end_col = 18
stats_start_col = 20
stats_end_col = 34
leaderboards_start_col = 35
leaderboards_end_col = 52
leaderboard_rows = 11
average_score_start_col = 54
average_score_end_col = 70
...
def split_date_range(date_range):
    ...
    # Calculate the quarter of the date range
    quarter_size = (end_date - start_date) // 4

    # Create four date ranges
    quarter1_end = start_date + quarter_size
    quarter2_end = quarter1_end + quarter_size
    quarter3_end = quarter2_end + quarter_size

    # Format the date strings for the four quarters
    quarter1_range = f'{start_date.strftime("%m/%d/%y")}-{quarter1_end.strftime("%m/%d/%y")}'
    quarter2_range = f'{quarter1_end.strftime("%m/%d/%y")}-{quarter2_end.strftime("%m/%d/%y")}'
    quarter3_range = f'{quarter2_end.strftime("%m/%d/%y")}-{quarter3_end.strftime("%m/%d/%y")}'
    quarter4_range = f'{quarter3_end.strftime("%m/%d/%y")}-{end_date.strftime("%m/%d/%y")}'

    return quarter1_range, quarter2_range, quarter3_range, quarter4_range
